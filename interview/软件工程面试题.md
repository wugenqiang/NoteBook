...
[软件工程复习题及参考答案](https://www.baidu.com/link?url=h_0wqXvmpZdL3XBLFoKOjepFxXa9h26fhpwjzopAUD5uMvQtYxjMcPAwY4R02ch-eqfbv9uHF-CQCsQgrxwEpo-cV_UQw6DrK5dXs5EJ_zC&wd=&eqid=c601bfa9000f5616000000035dd23048)

[软件工程复习题](https://wenku.baidu.com/view/3fb5940dda38376bae1fae93.html)

[软件工程主观习题](https://wenku.baidu.com/view/c673cc040740be1e650e9a7c.html)

[软件工程关键术语中英表](https://www.baidu.com/link?url=WPHvMR1RRnj_Z2A3fn2bxYyvdX8bIbEiQt5sMD_MR1b4JxfBqHO1CIO9UV33ATR_yT3ZR0nQ-zTeV5rgWrXiduADI7QGdRo04qgxrVeA2xm&wd=&eqid=cec100b6000af5d4000000035dd69f5b)
...
1. ![](https://keyon-photo-1256901694.cos.ap-beijing.myqcloud.com//markdown20191126205016.png)

   ![](https://keyon-photo-1256901694.cos.ap-beijing.myqcloud.com//markdown20191126205028.png)
...
2. 将下述伪代码改为NS图
   ...
   ![](https://keyon-photo-1256901694.cos.ap-beijing.myqcloud.com//markdown20191126205408.png)

3. ![](https://keyon-photo-1256901694.cos.ap-beijing.myqcloud.com//markdown20191126205614.png)

   判定覆盖要求每个判定结果都至少执行一次。

   图示有两个判定，每个判定的真假都执行一次。

   测试用例1：路径a->b->d	输入数据A=1 B=1 X=1 	预期输出结果X=1

   测试用例2：路径a->c->e     输入数据A=2 B=0 X=4	预期输出结果X=4

4. ![](https://keyon-photo-1256901694.cos.ap-beijing.myqcloud.com//markdown20191126211324.png)
